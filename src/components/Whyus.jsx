...
const Whyus = () => {
    return (
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px] gap-1 px-4 md:px-0 py-8'>
            ...
            <div className="w-full h-96 px-3.5 py-7 md:py-0 max-w-[600px] m-auto flex-col justify-start items-start inline-flex md:mr-[7rem] md:pt-0">
                ...
                <div className="self-stretch h-96 py-3.5 flex-col justify-center items-center gap-5 md:gap-7 flex">
                    <div className="self-stretch justify-start items-center gap-7 inline-flex">
                        <div className="grow shrink basis-0 h-28 mt-2 md:h-24 px-2 pt-2 rounded-md border border-[#e0dada] justify-center items-start gap-2 flex">
                    ...
                    <div className="self-stretch justify-start items-center gap-7 inline-flex">
                        <div className="grow shrink basis-0 h-28 md:h-24 px-2 pt-2 rounded-md border border-[#e0dada] justify-center items-start gap-2 flex">
                            <div className="w-22 h-22 justify-start items-start flex">
