        ...
        <div className=" block p-6 max-w-sm  m-auto bg-[#fff3f3] bg-opacity-60 rounded-lg shadow border border-white border-opacity-80 backdrop-blur-xl">
          ...
          <form>
            <div className="form-group mb-6">
              <label for="exampleInputEmail2" className="form-label inline-block mb-2 text-gray-700">Enter your name</label>
              <input type="name" className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
